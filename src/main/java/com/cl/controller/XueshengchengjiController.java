...
public class XueshengchengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengchengjiEntity xueshengchengji,
		...
		if(tableName.equals("xuesheng")) {
			xueshengchengji.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     * 分段统计
     */
    @RequestMapping("/sectionStat/chengji/kechengmingcheng")
    @IgnoreAuth
    public R kechengmingchengchengjiSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<XueshengchengjiEntity> ew = new EntityWrapper<XueshengchengjiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
        ...
        List<Map<String, Object>> result = xueshengchengjiService.kechengmingchengchengjiSectionStat(params, ew);
        return R.ok().put("data", result);
    }
