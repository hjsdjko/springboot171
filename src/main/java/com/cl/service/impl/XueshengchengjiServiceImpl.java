...
public class XueshengchengjiServiceImpl extends ServiceImpl<XueshengchengjiDao, XueshengchengjiEntity> implements XueshengchengjiService {
    ...
    @Override
    public List<Map<String, Object>> kechengmingchengchengjiSectionStat(Map<String, Object> params, Wrapper<XueshengchengjiEntity> wrapper) {
        return baseMapper.kechengmingchengchengjiSectionStat(params, wrapper);
    }
